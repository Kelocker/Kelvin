      ...
      <div className="grid grid-cols-1 md:grid-cols-12 ">
          ...
          >
            <h1 className="font-extrabold">
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    ...
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#9E7BFF">AI enthusiasm</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#893BFF">Problem solver</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .start();
            ...
            <p className="text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                href="https://drive.google.com/file/d/1WEDrgCoMgAe-SMgM6BZ8LEPgXbLafGjp/view?usp=sharing"
